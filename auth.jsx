...
[data-theme="dark"] .sidebar { background: #13151f; border-color: rgba(255,255,255,0.07); }
...
[data-theme="dark"] textarea { background: var(--surface2); border-color: var(--border2); color: var(--text); }
[data-theme="dark"] input::placeholder,
[data-theme="dark"] textarea::placeholder { color: var(--text3); }
[data-theme="dark"] .btn { background: var(--surface2); border-color: var(--border2); color: var(--text); }
[data-theme="dark"] .btn:hover { background: #2a2f45; }
[data-theme="dark"] .btn-primary { background: var(--green) !important; border-color: var(--green) !important; color: white !important; }
[data-theme="dark"] .btn-danger { background: var(--red-bg) !important; border-color: var(--red-border) !important; color: var(--red) !important; }
[data-theme="dark"] table thead tr { background: var(--surface2); }
[data-theme="dark"] table tbody tr:hover { background: var(--surface2); }
...
[data-theme="dark"] .modal-footer { background: var(--surface2); border-color: var(--border); }
[data-theme="dark"] .topbar { background: #13151f; border-color: rgba(255,255,255,0.07); }
[data-theme="dark"] .nav-section { color: var(--text3); }
[data-theme="dark"] .nav-user { border-color: var(--border); background: rgba(255,255,255,0.03); }
