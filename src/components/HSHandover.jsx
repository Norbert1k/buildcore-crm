...
const HS_STRUCTURE = [
  ...
  { key: 's3', label: 'Section 3 | Record Drawings', color: '#378ADD', bg: '#E6F1FB', children: [
    { key: 's3-1', label: '3.1 As Built Drawings', children: [
      ...
      { key: 's3-1-04', label: '04. Drawings', children: [
        ...
        { key: 's3-1-04-15', label: '04. Floor Plans', children: [] },
        { key: 's3-1-04-16', label: '05. Elevations', children: [] },
      ] },
      { key: 's3-1-05', label: '05. General Drawings', children: [
        { key: 's3-1-05-02', label: '01. Superseded', children: [] },
        { key: 's3-1-05-03', label: '02. Unclassified', children: [] },
        { key: 's3-1-05-07', label: '03. Windows', children: [] },
      ] },
    ] },
    { key: 's3-2', label: '3.2 Soft & Hard Landscaping', children: [] },
    { key: 's3-3', label: '3.3 Services Drawings', children: [] },
  ] },
  { key: 's4', label: 'Section 4 | Construction Materials', color: '#BA7517', bg: '#FAEEDA', children: [
    { key: 's4-1', label: '4.1 Schedule of Equipment', children: [
      { key: 's4-1-01', label: '01. Walls & Partitions', children: [
        { key: 's4-1-01-00', label: '01. Unclassified', children: [] },
      ] },
      { key: 's4-1-02', label: '02. Doors', children: [
        { key: 's4-1-02-02', label: '01. Ironmongery', children: [] },
        { key: 's4-1-02-03', label: '02. Doors', children: [] },
      ] },
      { key: 's4-1-04', label: '03. Roofing', children: [] },
      { key: 's4-1-05', label: '04. Radiators', children: [
        { key: 's4-1-05-02', label: '01. Bathrooms', children: [] },
      ] },
      { key: 's4-1-06', label: '05. Plumbing', children: [
        { key: 's4-1-06-03', label: '01. Gas Safe Certificates', children: [] },
      ] },
      { key: 's4-1-07', label: '06. Electrical', children: [] },
      { key: 's4-1-09', label: '07. Insulation', children: [] },
      { key: 's4-1-11', label: '08. Bathrooms', children: [] },
      { key: 's4-1-14', label: '09. MVHR', children: [] },
      { key: 's4-1-16', label: '10. Flooring', children: [] },
      { key: 's4-1-18', label: '11. Lifts', children: [
      ...
      { key: 's4-1-19', label: '12. Lighting', children: [] },
      { key: 's4-1-20', label: '13. Landscaping', children: [] },
      { key: 's4-1-23', label: '14. Windows', children: [] },
      { key: 's4-1-24', label: '15. Brickwork', children: [] },
      { key: 's4-1-25', label: '16. Kitchens', children: [] },
      { key: 's4-1-30', label: '17. Fire System', children: [] },
      { key: 's4-1-32', label: '18. Residents Information', children: [] },
      { key: 's4-1-34', label: '19. HVAC', children: [] },
    ] },
  ] },
  ...
  { key: 's7', label: 'Section 7 | Services', color: '#378ADD', bg: '#E6F1FB', children: [
    { key: 's7-1', label: '7.1 Services Overview', children: [
      ...
      { key: 's7-1-03', label: '02. Utilities', children: [
  ...
  { key: 's8', label: 'Section 8 | O&M Manuals', color: '#534AB7', bg: '#EEEDFE', children: [
    ...
    { key: 's8-2', label: '8.2 Façade & Roof Maintenance Information', children: [] },
    { key: 's8-3', label: '8.3 Cleaning and Maintenance', children: [] },
    { key: 's8-4', label: '8.4 Catalogue - All', children: [
      { key: 's8-4-01', label: '01. Walls & Partitions', children: [
        { key: 's8-4-01-00', label: '01. Unclassified', children: [] },
      ] },
      { key: 's8-4-02', label: '02. Doors', children: [
        { key: 's8-4-02-02', label: '01. Ironmongery', children: [] },
        { key: 's8-4-02-03', label: '02. Doors', children: [] },
      ] },
      { key: 's8-4-04', label: '03. Roof', children: [] },
      { key: 's8-4-05', label: '04. Radiators', children: [] },
      { key: 's8-4-06', label: '05. Plumbing', children: [
        { key: 's8-4-06-03', label: '01. Gas Safe Certificates', children: [] },
      ] },
      { key: 's8-4-07', label: '06. Electrical', children: [] },
      { key: 's8-4-09', label: '07. Insulation', children: [] },
      { key: 's8-4-11', label: '08. Bathrooms', children: [] },
      { key: 's8-4-15', label: '09. MVHR', children: [] },
      { key: 's8-4-17', label: '10. Flooring', children: [
        { key: 's8-4-17-01', label: '01. Tiles', children: [] },
      ] },
      { key: 's8-4-19', label: '11. Lifts', children: [
      ...
      { key: 's8-4-20', label: '12. Lighting', children: [] },
      { key: 's8-4-21', label: '13. Landscaping', children: [] },
      { key: 's8-4-24', label: '14. Windows', children: [] },
      { key: 's8-4-25', label: '15. Brickwork', children: [] },
      { key: 's8-4-26', label: '16. Kitchens', children: [] },
      { key: 's8-4-31', label: '17. Fire System', children: [
        { key: 's8-4-31-01', label: '01. Data Sheets', children: [] },
      ] },
      { key: 's8-4-33', label: '18. Residents Information', children: [] },
      { key: 's8-4-35', label: '19. HVAC', children: [] },
    ] },
  ] },
...
// Labels of template folders removed in the generic slim-down (Aug 2026).
// Any project holding files under one of these keys gets it back as an
// '(Archive)' folder automatically — content is never hidden or deleted.
const REMOVED_FOLDER_LABELS = {
  "s3-1-04-04": "04. Ceiling Layout",
  "s3-1-04-05": "05. Floor Setting Out Plan",
  "s3-1-04-06": "06. Floor Finishes",
  "s3-1-04-07": "07. Internal Wall Type",
  "s3-1-04-08": "08. External Wall Type",
  "s3-1-04-09": "09. Window and Door Code",
  "s3-1-04-10": "10. External Wall Setting Out",
  "s3-1-04-11": "11. Cavity Barrier Locations",
  "s3-1-04-12": "12. Proposed Stair Core",
  "s3-1-04-13": "13. Service Hole Setting Out",
  "s3-1-04-14": "14. Slab Setting Out",
  "s3-1-04-17": "17. Block Slab Edge",
  "s3-1-04-18": "18. Angled Brick Bay",
  "s3-1-04-19": "19. Lift Plan",
  "s3-1-04-20": "20. Sections AA BB CC",
  "s3-1-04-21": "21. Window Head Cill & Jamb",
  "s3-1-04-22": "22. Roof Detail & Type",
  "s3-1-04-23": "23. Special Shaped Bricks",
  "s3-1-04-24": "24. Bolt on Balcony",
  "s3-1-04-25": "25. Terrace",
  "s3-1-04-26": "26. Lift Overrun Junction",
  "s3-1-05-01": "01. Floor Area Measure",
  "s3-1-05-04": "04. External Wall Detail",
  "s3-1-05-05": "05. External Doors",
  "s3-1-05-06": "06. Internal Doors",
  "s3-1-05-08": "08. Substation",
  "s3-1-05-09": "09. Bathroom & Showers (Elevations)",
  "s3-1-05-10": "10. Internal Wall Types",
  "s3-1-05-11": "11. Separating Floor Types",
  "s3-1-05-12": "12. AOV Hatch",
  "s3-1-05-13": "13. Site Setting Out Plan",
  "s3-1-05-14": "14. Site Setting Out Externals",
  "s3-1-05-15": "15. Soffit Detail - Brick Wall",
  "s3-1-05-16": "16. Stone Detail External",
  "s3-1-05-17": "17. Brickwork Detail External",
  "s3-4": "3.4 Sprinkler",
  "s4-1-01-01": "01. Siniat",
  "s4-1-01-01-01": "01. Blue - Sound",
  "s4-1-01-01-02": "02. Pink - Fire",
  "s4-1-01-01-03": "03. Green - Moisture",
  "s4-1-01-01-04": "04. White - Standard",
  "s4-1-01-02": "02. Knauf",
  "s4-1-01-02-01": "01. Blue - Sound",
  "s4-1-01-02-02": "02. Pink - Fire",
  "s4-1-01-02-03": "03. Green - Moisture",
  "s4-1-01-02-04": "04. White - Standard",
  "s4-1-01-03": "03. British Gypsum",
  "s4-1-02-01": "01. Door Closer",
  "s4-1-02-04": "04. Door Handles",
  "s4-1-03": "03. Smoke Shaft",
  "s4-1-05-01": "01. Mylek Rads",
  "s4-1-06-01": "01. SVPs & RWPs",
  "s4-1-06-02": "02. Booster Set with Enhanced Controls",
  "s4-1-07-01": "01. CCTV",
  "s4-1-07-02": "02. Electric",
  "s4-1-07-03": "03. Intercom",
  "s4-1-08": "08. Mastics",
  "s4-1-10": "10. Lintels",
  "s4-1-12": "12. PV Panels",
  "s4-1-13": "13. Pipe Lagging",
  "s4-1-15": "15. Cylinders",
  "s4-1-17": "17. Fire Foam",
  "s4-1-21": "21. Lightning Conductor",
  "s4-1-22": "22. Plantroom Tanks",
  "s4-1-23-01": "01. Acoustics Specs",
  "s4-1-23-02": "02. Design Specs",
  "s4-1-23-03": "03. Cills",
  "s4-1-24-01": "01. Bricks",
  "s4-1-24-02": "02. Mortar",
  "s4-1-26": "26. Wardrobes",
  "s4-1-27": "27. Access Panels",
  "s4-1-28": "28. Bike & Bin Store (External)",
  "s4-1-29": "29. Balcony",
  "s4-1-29-01": "01. As-Built GAs",
  "s4-1-29-02": "02. COSHH",
  "s4-1-29-03": "03. Structural Calculations",
  "s4-1-31": "31. Sprinklers",
  "s4-1-33": "33. Fire Sealant & Paint",
  "s7-1-02": "02. As Built - Fire",
  "s7-1-02-01": "01. Unclassified",
  "s7-1-02-02": "02. As Fitted Drawings - As Wired Devices",
  "s7-1-02-03": "03. Fire Strategy",
  "s7-1-02-04": "04. Fire System Data",
  "s7-1-02-04-01": "01. Data Sheets",
  "s8-4-01-01": "01. Siniat",
  "s8-4-01-01-01": "01. Blue - Sound",
  "s8-4-01-01-02": "02. Pink - Fire",
  "s8-4-01-01-03": "03. Green - Moisture",
  "s8-4-01-01-04": "04. White - Standard",
  "s8-4-01-02": "02. Knauf",
  "s8-4-01-02-01": "01. Blue - Sound",
  "s8-4-01-02-02": "02. Pink - Fire",
  "s8-4-01-02-03": "03. Green - Moisture",
  "s8-4-01-02-04": "04. White - Standard",
  "s8-4-01-03": "03. British Gypsum",
  "s8-4-02-01": "01. Door Closer",
  "s8-4-02-04": "04. Door Handles",
  "s8-4-03": "03. Smoke Shaft",
  "s8-4-06-01": "01. SVPs & RWPs",
  "s8-4-06-02": "02. Booster Set with Enhanced Controls",
  "s8-4-07-01": "01. CCTV",
  "s8-4-07-02": "02. Electric",
  "s8-4-07-03": "03. Intercom",
  "s8-4-08": "08. Mastics",
  "s8-4-10": "10. Lintels",
  "s8-4-12": "12. PV Panels",
  "s8-4-13": "13. Power On",
  "s8-4-13-01": "01. Electrical Design Pack",
  "s8-4-13-02": "02. Fibre",
  "s8-4-13-03": "03. Electrical Design Pack",
  "s8-4-14": "14. Pipe Lagging",
  "s8-4-16": "16. Cylinders",
  "s8-4-17-02": "02. Carpet Tile",
  "s8-4-18": "18. Fire Foam",
  "s8-4-22": "22. Lightning Conductor",
  "s8-4-23": "23. Plantroom Tanks",
  "s8-4-24-01": "01. Acoustics Specs",
  "s8-4-24-02": "02. Design Spec",
  "s8-4-24-03": "03. Cills",
  "s8-4-25-01": "01. Bricks",
  "s8-4-25-02": "02. Mortar",
  "s8-4-27": "27. Wardrobes",
  "s8-4-28": "28. Access Panels",
  "s8-4-29": "29. Bike & Bin Store (External)",
  "s8-4-30": "30. Balcony",
  "s8-4-30-01": "01. As-Built GAs",
  "s8-4-30-02": "02. COSHH",
  "s8-4-30-03": "03. Structural Calculations",
  "s8-4-32": "32. Sprinklers",
  "s8-4-34": "34. Fire Sealant & Paint",
  "s8-4-36": "36. Paint",
  "s8-4-37": "37. OFNL",
  "s11-1-01": "01. Flats Certs",
  "s11-1-02": "02. Building Insurance",
  "s11-2-01": "01. Communal Lighting",
  "s11-2-02": "02. Emergency Lighting",
  "s11-3-01": "01. EICR",
  "s11-4-01": "01. Commissioning Certificates",
  "s11-8-01": "01. EPCs",
  "s11-8-02": "02. SAPs",
  "s11-9-01": "01. MVHR Air Test",
  "s11-9-02": "02. Air Permeability Test",
  "s11-9-03": "03. Sound Test"
}
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', zIndex: 1000, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 20 }} onClick={onClose}>
      <div style={{ position: 'absolute', top: 16, right: 16, display: 'flex', gap: 8, zIndex: 1 }}>
        {onDownload && <button onClick={e => { e.stopPropagation(); onDownload() }} style={{ fontSize: 12, padding: '6px 12px', background: 'rgba(255,255,255,0.15)', color: '#fff', borderRadius: 'var(--radius)', border: '0.5px solid rgba(255,255,255,0.3)', cursor: 'pointer' }}>↓ Download</button>}
        <button onClick={onClose} style={{ fontSize: 12, padding: '6px 12px', background: 'rgba(255,255,255,0.15)', color: '#fff', borderRadius: 'var(--radius)', border: '0.5px solid rgba(255,255,255,0.3)', cursor: 'pointer' }}>✕ Close</button>
      </div>
      ...
      <div onClick={e => e.stopPropagation()} style={{ flex: 1, width: '95vw', maxHeight: '85vh', overflow: 'auto', background: '#fff', borderRadius: 'var(--radius)', padding: 0 }}>
...
function HSFileCard({ file, onDelete, canDelete, selected, onSelect, onPreview }) {
  ...
  function TypeBadge() {
    ...
    return <div style={{ width: 34, height: 42, background: color, borderRadius: 'var(--radius)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><span style={{ color: '#fff', fontSize: 17, fontWeight: 700, fontFamily: 'Arial' }}>{letter}</span></div>
  }

  return (
    <>
      <div draggable={!renaming} style={{ border: selected ? '2px solid var(--accent)' : '0.5px solid var(--border)', borderRadius: 'var(--radius)', overflow: 'hidden', background: 'var(--surface)', fontSize: 12, position: 'relative', transition: 'border .1s' }}>
      ...
      {confirmDel && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={() => setConfirmDel(false)}>
          <div style={{ background: 'var(--surface)', borderRadius: 'var(--radius)', padding: 24, maxWidth: 360, width: '90%' }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
              <button onClick={() => setConfirmDel(false)} style={{ fontSize: 11, lineHeight: '24px', padding: '0 9px', border: '0.5px solid var(--border)', borderRadius: 'var(--radius)', background: 'transparent', cursor: 'pointer', color: 'var(--text2)' }}>Cancel</button>
              <button onClick={() => { setConfirmDel(false); onDelete(file) }} style={{ fontSize: 11, lineHeight: '24px', padding: '0 9px', border: '0.5px solid var(--red-border)', borderRadius: 'var(--radius)', background: 'transparent', cursor: 'pointer', color: 'var(--red)' }}>Delete</button>
            </div>
          </div>
        </div>
      )}
...
function HSFileListRow({ file, onDelete, canDelete, selected, onSelect, onPreview }) {
  ...
  return (
    <>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '6px 10px', borderRadius: 'var(--radius)', border: selected ? '1.5px solid var(--accent)' : '0.5px solid var(--border)', background: 'var(--surface)', transition: 'border .1s' }}>
        <div onClick={e => { e.stopPropagation(); onSelect && onSelect(file.id) }}
    ...
    <div style={{ marginLeft: indent > 0 ? 0 : 0 }}>
      ...
      >
        ...
        {(() => {
          ...
          return (
            <div style={{ width: isSection ? 32 : 24, height: isSection ? 32 : 24, borderRadius: 'var(--radius)', background: isCustom ? '#F1EFE8' : bg, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              {IconSvg
          ...
          {showAddFolder ? (
            <>
              <input value={newFolderName} onChange={e => setNewFolderName(e.target.value)} placeholder="Subfolder name" autoFocus
                ...
                style={{ fontSize: 11, lineHeight: '24px', padding: '0 8px', border: '0.5px solid var(--border)', borderRadius: 'var(--radius)', background: 'var(--surface2)', color: 'var(--text)', width: 130 }} />
      ...
      {open && (
        <div onDragOver={e => e.preventDefault()} onDrop={onDrop}
          ...
          {files.length === 0 && !hasChildren && canManage && (
            <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, height: 48, border: '0.5px dashed var(--border)', borderRadius: 'var(--radius)', cursor: 'pointer', color: 'var(--text3)', fontSize: 11, margin: '4px 0' }}>
...
export default function HSHandover({ projectId, projectName }) {
  ...
  async function loadCustomFolders() {
    ...
    // ── Archive resurrection: any template folder removed in the generic
    //    slim-down that still HOLDS FILES on this project comes back as an
    //    '(Archive)' folder under its nearest surviving ancestor. Files are
    //    never hidden or touched. Synthetic entries ride the customFolders
    //    channel so the renderer needs no special handling.
    const { data: fileKeysRows } = await supabase.from('hs_files').select('folder_key').eq('project_id', projectId)
    const templateKeys = new Set()
    ;(function wk(ns){ ns.forEach(n => { templateKeys.add(n.key); wk(n.children) }) })(HS_STRUCTURE)
    const customKeys = new Set((data || []).map(f => f.folder_key))
    const orphanKeys = [...new Set((fileKeysRows || []).map(r => r.folder_key))]
      .filter(k => k && !templateKeys.has(k) && !customKeys.has(k))
    const nearestKeptAncestor = (key) => {
      const parts = key.split('-')
      for (let i = parts.length - 1; i >= 1; i--) {
        const cand = parts.slice(0, i).join('-')
        if (templateKeys.has(cand)) return cand
      }
      return parts[0]
    }
    const archiveEntries = orphanKeys.map(k => ({
      folder_key: k,
      parent_key: nearestKeptAncestor(k),
      label: `(Archive) ${REMOVED_FOLDER_LABELS[k] || k}`,
      _archive: true,
    }))
    setCustomFolders([...(data || []), ...archiveEntries])
  }
    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, flexWrap: 'wrap', gap: 8 }}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <button onClick={zipAll} disabled={zippingAll} style={{ fontSize: 12, padding: '7px 14px', border: '0.5px solid var(--border)', borderRadius: 'var(--radius)', background: 'transparent', cursor: 'pointer', color: 'var(--text2)', display: 'flex', alignItems: 'center', gap: 5 }}>
          ...
          <button onClick={compileOmManuals} disabled={compilingOm} style={{ fontSize: 12, padding: '7px 14px', border: '0.5px solid #534AB7', borderRadius: 'var(--radius)', background: 'transparent', cursor: 'pointer', color: '#534AB7', display: 'flex', alignItems: 'center', gap: 5 }}>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            {compilingOm ? 'Compiling...' : 'Export Section 8 O&M PDF'}
          </button>
          <button onClick={compileFullHandover} disabled={compilingFull} style={{ fontSize: 12, padding: '7px 14px', borderRadius: 'var(--radius)', background: '#448a40', color: 'white', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 5 }}>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
      ...
      {/* Note */}
      <div style={{ marginTop: 16, padding: '10px 14px', background: 'var(--surface2)', borderRadius: 'var(--radius)', fontSize: 11, color: 'var(--text3)' }}>
      ...
      {previewFile && (
        /\.xlsx?$/i.test(previewFile.file_name)
          ...
          <div style={{ position: 'absolute', top: 16, right: 16, display: 'flex', gap: 8 }}>
            {previewUrl && <button onClick={e => { e.stopPropagation(); triggerDownload(previewUrl, previewFile.file_name) }} style={{ fontSize: 12, padding: '6px 12px', background: 'rgba(255,255,255,0.15)', color: '#fff', borderRadius: 'var(--radius)', border: '0.5px solid rgba(255,255,255,0.3)', cursor: 'pointer' }}>↓ Download</button>}
            <button onClick={() => setPreviewFile(null)} style={{ fontSize: 12, padding: '6px 12px', background: 'rgba(255,255,255,0.15)', color: '#fff', borderRadius: 'var(--radius)', border: '0.5px solid rgba(255,255,255,0.3)', cursor: 'pointer' }}>✕ Close</button>
          </div>
          ...
          {previewUrl ? (
            /\.(jpg|jpeg|png|gif|webp)$/i.test(previewFile.file_name)
              ? <img src={previewUrl} alt={previewFile.file_name} style={{ maxWidth: '90vw', maxHeight: '80vh', objectFit: 'contain', borderRadius: 'var(--radius)' }} onClick={e => e.stopPropagation()} />
              : /\.pdf$/i.test(previewFile.file_name)
              ? <iframe src={previewUrl} style={{ width: '95vw', height: '92vh', border: 'none', borderRadius: 'var(--radius)' }} title={previewFile.file_name} onClick={e => e.stopPropagation()} />
              : <iframe src={'https://docs.google.com/gview?url=' + encodeURIComponent(previewUrl) + '&embedded=true'} style={{ width: '95vw', height: '92vh', border: 'none', borderRadius: 'var(--radius)', background: '#fff' }} title={previewFile.file_name} onClick={e => e.stopPropagation()} />
          ) : (
