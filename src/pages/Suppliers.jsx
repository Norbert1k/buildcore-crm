    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 16, flexWrap: 'wrap' }}>
        ...
        <div className="filter-tabs" style={{ marginBottom: 0 }}>
          <div className={`filter-tab ${filter === 'all' ? 'active' : ''}`} onClick={() => setFilter('all')}>All ({suppliers.length})</div>
          <div className={`filter-tab ${filter === 'active' ? 'active' : ''}`} onClick={() => setFilter('active')}>Active ({active})</div>
          <div className={`filter-tab ${filter === 'inactive' ? 'active' : ''}`} onClick={() => setFilter('inactive')}>Inactive ({suppliers.length - active})</div>
        </div>
      </div>
